            ...
            <div class="row">
                ...
                <?php
                    if(isset($_GET['submit'])){
                        ...
                        mysqli_close($conn);
                        echo "เพิ่มข้อมูลสาขา $prg_name เรียบร้อยแล้ว<br>";
                        echo '<a href="program_list.php">แสดงข้อมูลสาขาทั้งหมด</a>';
                    }else{
                ?>
                    <form class="form-horizontal" role="form" name="prg_add" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <div class="form-group">
                            <label for="prg_name" class="col-md-2 col-lg-2 control-label">สาขา</label>
