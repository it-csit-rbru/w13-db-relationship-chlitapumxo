                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                    ...
                    <form class="form-horizontal" role="form" name="student_add" action="<?php echo $_SERVER['PHP_SELF'];?>">
                        <div class="form-group">
                            <label for="std_prg_id" class="col-md-2 col-lg-2 control-label">โปรแกรมวิชา</label>
                        ...
                        <div class="form-group">
                            <label for="std_sid" class="col-md-2 col-lg-2 control-label">รหัสนักศึกษา</label>
                            <div class="col-md-10 col-lg-10">
