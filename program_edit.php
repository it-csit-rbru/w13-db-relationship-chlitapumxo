            ...
            <div class="row">
                ...
                <?php
                    ...
                    if(isset($_GET['submit'])){
                        ...
                        $sql        = "update program_edit set prg_name='$prg_name' where prg_id='$prg_id'";
                        mysqli_query($conn,$sql);
                        mysqli_close($conn);
                        echo "แก้ไข $prg_name เรียบร้อยแล้ว<br>";
                        echo '<a href="program_edit.php">แสดงเครื่องมือทั้งหมด</a>';
                    }else{
                        $fprg_id = $_REQUEST['prg_id'];
                        $sql =  "SELECT * FROM program_edit where prg_id='$fprg_id'";
